...
public class Service : IService
{
	...
	public DataSet gvdEmpleado()
	{
		try
		{
			da = new SqlDataAdapter("gvdEmpleado", Conexion);
			da.SelectCommand.CommandType = CommandType.StoredProcedure;
			da.Fill(ds, "gvdEmpleado");
			return ds;
		}
		catch (Exception)
		{//Enviar correo al administrador o al programador del error ocurrido
	...
	public DataSet gvdContrato()
	{
		try
		{
			da = new SqlDataAdapter("gvdContrato", Conexion);
			da.SelectCommand.CommandType = CommandType.StoredProcedure;
			da.Fill(ds, "gvdContrato");
			return ds;
		}
		catch (Exception)
		{//Enviar correo al administrador o al programador del error ocurrido
	...
	public DataSet listAño(int id_empleado)
	{
		try
		{
			da = new SqlDataAdapter("listAño", Conexion);
			da.SelectCommand.CommandType = CommandType.StoredProcedure;
			da.SelectCommand.Parameters.AddWithValue("@id_empleado", id_empleado);
			da.Fill(ds, "listAño");
			return ds;
	...
	public DataSet GenerarBoleta(int id_empleado, int año, int mes)
	{
		try
		{
			da = new SqlDataAdapter("GenerarBoleta", Conexion);
			da.SelectCommand.CommandType = CommandType.StoredProcedure;
			da.SelectCommand.Parameters.AddWithValue("@id_empleado", id_empleado);
			da.SelectCommand.Parameters.AddWithValue("@año", año);
			da.SelectCommand.Parameters.AddWithValue("@mes", mes);
			da.Fill(ds, "GenerarBoleta");
			return ds;
		}
		catch (Exception)
		{//Enviar correo al administrador o al programador del error ocurrido
